window.onload = function () {  
    ...
    var marker_16 = L.marker([52, -9]).addTo(mymap);
    var marker_17 = L.marker([52, -10]).addTo(mymap);
    var marker_18 = L.marker([52, -8]).addTo(mymap);

    var marker_21 = L.marker([50.2, -22]).addTo(mymap);
    var marker_20 = L.marker([52, -26]).addTo(mymap);
    var marker_19 = L.marker([50, -24]).addTo(mymap);

    var marker_22 = L.marker([45, -25]).addTo(mymap);
    var marker_23 = L.marker([46, -26]).addTo(mymap);
    var marker_24 = L.marker([45, -24]).addTo(mymap);

    var marker_25 = L.marker([55.5, -2]).addTo(mymap);
    var marker_26 = L.marker([55.8, 1]).addTo(mymap);
    var marker_27 = L.marker([54, -1]).addTo(mymap);
    ...
    marker_16.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Italy<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;152</span>",{closeButton:false,closeOnClick: false,}).openPopup();
    marker_17.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Italy<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;193</span>",{closeButton:false,closeOnClick: false,}).openPopup();
    marker_18.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Italy<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;228</span>",{closeButton:false,closeOnClick: false,}).openPopup();

    marker_19.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Espana<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;152</span>",{closeButton:false,closeOnClick: false,}).openPopup();
    marker_20.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Espana<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;193</span>",{closeButton:false,closeOnClick: false,}).openPopup();
    marker_21.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Espana<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;228</span>",{closeButton:false,closeOnClick: false,}).openPopup();

    marker_22.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Algerie<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;152</span>",{closeButton:false,closeOnClick: false,}).openPopup();
    marker_23.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Algerie<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;193</span>",{closeButton:false,closeOnClick: false,}).openPopup();
    marker_24.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Algerie<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;228</span>",{closeButton:false,closeOnClick: false,}).openPopup();

    marker_25.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Romania<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;152</span>",{closeButton:false,closeOnClick: false,}).openPopup();
    marker_26.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Romania<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;193</span>",{closeButton:false,closeOnClick: false,}).openPopup();
    marker_27.bindPopup("<b>Company name</b><br>I am marker no street name<br/>00120<br/>Romania<br/><span><i class='fa fa-building' style='color:gray;'></i></span><span style='color:gray;'>&nbsp;&nbsp;228</span>",{closeButton:false,closeOnClick: false,}).openPopup();
  ...
  var ctx = document.getElementById("pie-chart2").getContext("2d");
    ...
    data:{
      datasets:[{
        ...
        backgroundColor:['#05A08E','#53A005','#058EA0','#A00591','#A09A05'],
      }],
      labels:['France','Irlande','Belgique','Tunisie','Allemagne']
    },
    options: {
      legend:{
        display:false
